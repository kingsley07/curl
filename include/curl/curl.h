...
/*
 * NAME curl_set_locking_callback()
 *
 */

CURL_EXTERN void curl_set_locking_callback(void(*func) (int mode, int type, const char *file, int line));
CURL_EXTERN void curl_set_id_callback(unsigned long(*func) (void));
...
#define CURL_CRYPTO_LOCK             1
#define CURL_CRYPTO_UNLOCK           2
#define CURL_CRYPTO_READ             4
#define CURL_CRYPTO_WRITE            8
